...
class LeNetConvPoolLayer(object):
    ...
    def __init__(self, rng, input, filter_shape, image_shape, poolsize=(2, 2), pool_flag = True):
        """
        ...
        if pool_flag:
            pooled_out = pool.pool_2d(
                input= conv_out, #rectified_conv_out
                ds=poolsize,
                ignore_border=True
            )
            self.transformed = pooled_out
