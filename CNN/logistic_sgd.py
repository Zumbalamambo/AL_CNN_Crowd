...
class LogisticRegression(object):
    ...
    def __init__(self, input, n_in, n_out):
        ...
        # self.relu_y_given_x = T.nnet.relu(self.y_given_x)
        self.p_y_given_x = T.nnet.softmax(self.y_given_x)
    ...
    def get_p_y_given_x(self,y):
        return  self.y_given_x , T.nnet.softmax(self.y_given_x) #)[T.arange(y.shape[0]), y]

    def get_y_pred(self):
        return self.y_pred

    def get_y_given_x(self):
        return self.y_given_x

    def get_relu_y_given_x(self):
        return self.relu_y_given_x